...
*TL;DR: In most cases, put `author: [Etevaldo Costa]` in the document's front matter, for sites with multiple authors. If you need something more complicated, read on.*
